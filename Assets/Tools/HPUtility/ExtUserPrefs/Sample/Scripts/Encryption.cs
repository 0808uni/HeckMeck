namespace HKUtility
{
    ...
    public static class Encryption
    {
        ...
        // private const string PASS = "5QAktzUmG64xiNNLrjXvTyjs";
        static string PASS;
        ...
        /// <param name="pass">暗号化パスワード</param>
        /// <returns>暗号化された文字列</returns>
        public static string EncryptString(string sourceString, string pass)
        {
            PASS = pass;
            ...
            using (System.Security.Cryptography.RijndaelManaged rijndael =
        ...
        public static string DecryptString(string sourceString, string pass)
        {
            PASS = pass;
        ...
        private static void GenerateKeyFromPassword(int keySize, out byte[] key, int blockSize, out byte[] iv)
        {
            ...
            using (System.Security.Cryptography.Rfc2898DeriveBytes deriveBytes =
